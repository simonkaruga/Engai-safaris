      ...
      <section className="bg-gradient-to-br from-teal-50 via-white to-stone-100 pt-20 pb-16 px-4 md:px-6 relative overflow-hidden border-b border-stone-100">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="max-w-2xl">
            <p className="eyebrow text-teal-DEFAULT mb-4">{t("reviews.subtitle")}</p>
            <h1 className="font-display text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-5">
              {t("reviews.headline").split(" after")[0]}<br />
          ...
          <div className="mt-12 flex flex-wrap gap-10 items-center">
            <div>
              ...
              <p className="text-gray-400 text-xs mt-1">{t("reviews.outOf5")}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">{t("reviews.verifiedReviews")}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-14">
          ...
          <div className="lg:col-span-2">
            <p className="eyebrow text-teal-DEFAULT mb-3">{t("reviews.title")}</p>
          ...
          <div>
            <div className="bg-white border border-gray-100 rounded-2xl p-7 shadow-card">
              <p className="eyebrow text-teal-DEFAULT mb-2">{t("reviews.shareExperience")}</p>
              <h2 className="font-display text-2xl font-bold text-gray-900 mb-1">{t("reviews.writeReview")}</h2>
              <p className="text-gray-500 text-sm mb-6 leading-relaxed">
                {t("reviews.traveled")} Tell others what it was really like.
              </p>
              <ReviewForm />
            </div>
          </div>
