        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-28">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-card p-6 mb-8">
              <p className="text-xs font-semibold tracking-widest uppercase text-gray-400 mb-4">{t("plan.whatEngaiKnows")}</p>
            ...
            <div className="space-y-4">
              {HOW_STEPS.map(({ step, titleKey, desc }) => (
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-xs text-gray-400 mb-3">{t("plan.preferWhatsApp")}</p>
              <a
