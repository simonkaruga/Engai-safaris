...
from app.routers.public import safaris, destinations, guides, reviews, blog, enquiries, ai_planner, partner_lodges, availability, currency as currency_router, contact as contact_router, newsletter as newsletter_router, memories as memories_router, receipts as receipts_router, partners as partners_router
...
app.include_router(partners_router.router, prefix="/api")
