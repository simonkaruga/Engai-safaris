...
ALTER TABLE destinations ADD COLUMN IF NOT EXISTS park_fees_usd NUMERIC(8,2);
ALTER TABLE destinations ADD COLUMN IF NOT EXISTS conservancy_fees_usd NUMERIC(8,2);

ALTER TABLE safaris ADD COLUMN IF NOT EXISTS is_available BOOLEAN NOT NULL DEFAULT true;
ALTER TABLE safaris ADD COLUMN IF NOT EXISTS availability_note TEXT;

ALTER TABLE bookings ADD COLUMN IF NOT EXISTS promo_code VARCHAR(50);
ALTER TABLE bookings ADD COLUMN IF NOT EXISTS promo_discount_kes NUMERIC(10,2) DEFAULT 0;

ALTER TABLE safaris ADD COLUMN IF NOT EXISTS is_shared BOOLEAN NOT NULL DEFAULT false;

ALTER TABLE bookings ADD COLUMN IF NOT EXISTS vehicle_ref VARCHAR(100);

ALTER TABLE safaris ADD COLUMN IF NOT EXISTS cost_per_pax_usd NUMERIC(10,2);
ALTER TABLE safaris ADD COLUMN IF NOT EXISTS profit_margin_pct INTEGER DEFAULT 30;

-- Create partner_lodges table
CREATE TABLE IF NOT EXISTS partner_lodges (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    name VARCHAR(200) NOT NULL,
...
ALTER TABLE safaris ADD COLUMN IF NOT EXISTS beach_extension_days INTEGER DEFAULT 0;
ALTER TABLE safaris ADD COLUMN IF NOT EXISTS beach_location VARCHAR(100);

-- Create indexes for better performance
CREATE INDEX IF NOT EXISTS idx_destinations_slug ON destinations(slug);
CREATE INDEX IF NOT EXISTS idx_destinations_country ON destinations(country);
CREATE INDEX IF NOT EXISTS idx_safaris_slug ON safaris(slug);
CREATE INDEX IF NOT EXISTS idx_safaris_is_active ON safaris(is_active);
